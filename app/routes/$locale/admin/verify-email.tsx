...
function RouteComponent() {
  ...
  const verifyPasswordResetEmailMutation = useServerFn(verifyPasswordResetEmail)
  const resendEmailVerificationMutation = useServerFn(resendEmailVerification)
    ...
    <div className="mx-auto flex h-screen w-screen max-w-[400px] flex-col justify-center gap-4 p-4">
      ...
      <div className="flex items-start justify-start gap-1">
        ...
        <Button
          ...
          className={'gap-1'}
        >
          {resendCodeSent && <Loader2 size={16} className="animate-spin" />}
