    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-4 py-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2 rounded-lg border border-gray-200 bg-white p-4">
          <h2 className="mb-4 text-xl font-bold">{translations.contact}</h2>
          {/* Address */}
          <Contact
        ...
        <div className="flex flex-col gap-2 rounded-lg border border-gray-200 bg-white p-4">
          ...
          {getLocalizedField(resource.body, language)?.preparationRequired! && (
            <Contact
              ...
              value={
                getLocalizedField(resource.body, language)!.preparationNotes!
              }
        ...
        {hours.length > 0 && (
          <div className="flex flex-col gap-2 rounded-lg border border-gray-200 bg-white p-4">
            <h2 className="mb-4 text-xl font-bold">{translations.hours}</h2>
            {/* Hours */}
            {hours &&
              hours.map((hour) => (
                <div
                  key={hour.day}
                  className={"flex w-64 items-center justify-between gap-3"}
                >
                  <h3
                    className={cn(
                      "font-medium",
